			...
			<div id="page-header">
				...
				<Link to="/analytics">
					<button id="page-header-button">
						...
						<body id="page-header-button-text">Hackathon Analytics</body>
					</button>
				</Link>
			</div>
				...
				<div id="page-links-grid">
					<Link to="/hackathon">
						<button className="page-links-grid-button">						
							...
							<body className="page-links-grid-button-text">Go to Hackathon</body>
						</button>
					</Link>		
					...
					<Link to="/attendees">
						<button className="page-links-grid-button">						
							<PageLinksIcon className="page-links-grid-button-icon"/> 
							<body className="page-links-grid-button-text">Attendees</body>
						</button>
					</Link>
					...
					<Link to="/sponsors">
						<button className="page-links-grid-button">						
							<PageLinksIcon className="page-links-grid-button-icon"/> 
							<body className="page-links-grid-button-text">Sponsors</body>
						</button>
					</Link>
					...
					<Link to="/edit-details">
						<button className="page-links-grid-button">						
							<PageLinksIcon className="page-links-grid-button-icon"/> 
							<body className="page-links-grid-button-text">Edit Details</body>
						</button>
					</Link>
					...
					<Link to="/schedule">
						<button className="page-links-grid-button">						
							<PageLinksIcon className="page-links-grid-button-icon"/> 
							<body className="page-links-grid-button-text">Schedule</body>
						</button>
					</Link>
					...
					<Link to="/settings">
						<button className="page-links-grid-button">						
							<PageLinksIcon className="page-links-grid-button-icon"/> 
							<body className="page-links-grid-button-text">Settings</body>
						</button>
					</Link>	
				</div>
			</div>
			...
			<div id="page-subheader-2">
				...
				<Link to="/">
					<button id="page-subheader-2-button">
						...
						<body id="page-subheader-2-button-text">Create Hackathon</body>
					</button>
				</Link>				
			</div>
